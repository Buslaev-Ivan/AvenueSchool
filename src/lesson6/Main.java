...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("По какому варианту осуществляем поиск");
        ...
        else System.out.println("перезапустите программу и повторите запрос");
